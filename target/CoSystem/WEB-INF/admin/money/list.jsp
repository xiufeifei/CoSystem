...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 基础数据 <span class="c-gray en">&gt;</span> 党费详情<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
        <a class="btn btn-primary radius" data-title="添加记录" data-href="<%=admin%>money/moneyAdd"
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
			<c:forEach items="${data.records}" var="money">
				<tr class="text-c">
					<td>${money.id}</td>
					<td>${money.amount}</td>
					<td>${money.createTimeStr}</td>
					<td>${money.updateTimeStr}</td>
