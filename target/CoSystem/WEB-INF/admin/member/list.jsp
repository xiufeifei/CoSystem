...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="javascript:;" onclick="member_add('添加用户','<%=admin%>/member/add.jsp','','510')" class="btn btn-primary radius">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<tr class="text-c">
				...
				<td>1</td>
				<td>
                    <u style="cursor:pointer" class="text-primary" onclick="member_show('张三','<%=admin%>/member/show.jsp','10001','360','400')">张三</u>
                </td>
				<td>男</td>
				<td>13000000000</td>
				...
				<td class="td-manage">
                    ...
                    <a title="编辑" href="javascript:;" onclick="member_edit('编辑','<%=admin%>/member/add.jsp','4','','510')" class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
