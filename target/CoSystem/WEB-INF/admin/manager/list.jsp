...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="javascript:;" onclick="admin_add('添加管理员','<%=admin%>/manager/useradd.jsp','800','500')" class="btn btn-primary radius">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<tr class="text-c">
        <c:forEach items="${data.records}" var="admin">
	<tr class="text-c">
			<td><input type="checkbox" value="" name=""></td>
			<td>${admin.id}</td>
			<td>${admin.account}</td>
			<td>${admin.name}</td>
			<td>${admin.createTimeStr}</td>
			<td>${admin.updateTimeStr}</td>
			<td>${admin.info}</td>
				...
				<td class="td-manage">
                    ...
                    <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','<%=admin%>/manager/useradd.jsp','1','800','500')" class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
