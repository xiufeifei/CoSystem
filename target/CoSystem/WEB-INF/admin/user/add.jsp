...
<article class="page-container">
	<form action="${pageContext.request.contextPath}/admin/user/add" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>入党状态：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>所属支部：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>老师/学生：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
			...
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>人员状态：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
